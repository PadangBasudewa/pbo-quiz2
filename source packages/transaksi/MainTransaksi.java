...
public class MainTransaksi extends javax.swing.JFrame {
    private int id = 0; // id variable untuk kode transaksi
    private String code; // kode variable untuk kode transaksi
    private DefaultComboBoxModel cbModel; // Jcombobox model
    private DefaultTableModel tbModel; // Jtable model 
    private ArrayList<Item> cart = new ArrayList<>(); // cart variable untuk menyimpan transaksi
    ...
    // check jika table kosong
    private boolean isEmpty() {
        return this.tblListItems.getModel().getRowCount()<=0;
    }
    
    // mengnonaktifkan Remove and Save button jika kosong
    ...
    // commit new Transaction setelah selesai Transaction
    private void newTrx() {
        this.txtJml.setText("");
